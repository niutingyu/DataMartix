...
- (void)viewDidLoad {
    ...
    [but setImage:[UIImage imageNamed:@"bulb"] forState:UIControlStateSelected];
    [but setImage:[UIImage imageNamed:@"bulb-normal"] forState:UIControlStateNormal];
...
- (void)showError:(NSString*)str withReset:(BOOL)isRest
{
    ...
    UIAlertAction *confirmAction = [UIAlertAction actionWithTitle:@"确认" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        if (![str isEqualToString:@"扫码失败，请重新扫一扫"]) {
            if (self.scanSucessMethod) {
                self.scanSucessMethod(str);
            }
